...
layui.define(['element', 'common'], function (exports) {
    ...
    Tab.prototype.tabAdd = function (data) {
        ...
        if (tabIndex === -1) {
            ...
            window.sessionStorage.setItem("currmenu",JSON.stringify(data));*/
                        ...
                        $that.on('click', function () {
                            ...
                            switch (target) {
                                ...
                                case 'closeAll': //全部关闭
                                    ...
                                    ELEM.titleBox.children('li').addClass('layui-this');
                                    if( $('.layui-tab-content .layui-tab-item').length==2){
                                        $('.layui-tab-content .layui-tab-item:last').remove();
                                        $('.layui-tab-content .layui-tab-item').addClass('layui-show');
                                    }
                                    break;
                            }
                            /*var iframe=$('.layui-tab-content .layui-show iframe').contentDocument;
                            console.log(iframe.getElementsByTagName('title'));
                            if($('.layui-tab-content .layui-show').find('title').html()=='登录'){
